...
Implementation Notes:
    Fill this in for the service that you write
...
#define SERV_0_HEADER "ButtonService.h"
// the name of the Init function
#define SERV_0_INIT InitButton
// the name of the run function
#define SERV_0_RUN RunButton
// How big should this services Queue be?
#define SERV_0_QUEUE_SIZE 3 // Lets keep this for now 
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "YeezyService.h"
// the name of the Init function
#define SERV_1_INIT InitYeezy
// the name of the run function
#define SERV_1_RUN RunYeezy
// How big should this services Queue be?
...
#if NUM_SERVICES > 2
// the header file with the public function prototypes
#define SERV_2_HEADER "Audio.h"
// the name of the Init function
#define SERV_2_INIT InitAudio
// the name of the run function
#define SERV_2_RUN RunAudio
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "HypeLights.h"
// the name of the Init function
#define SERV_3_INIT InitHypeLights
// the name of the run function
#define SERV_3_RUN RunHypeLights
// How big should this services Queue be?
...
#if NUM_SERVICES > 4
// the header file with the public function prototypes
#define SERV_4_HEADER "Glasses.h"
// the name of the Init function
#define SERV_4_INIT InitGlasses
// the name of the run function
#define SERV_4_RUN RunGlasses
// How big should this services Queue be?
...
#if NUM_SERVICES > 5
// the header file with the public function prototypes
#define SERV_5_HEADER "Needle.h"
// the name of the Init function
#define SERV_5_INIT InitNeedle
// the name of the run function
#define SERV_5_RUN RunNeedle
// How big should this services Queue be?
...
#define NUM_DIST_LISTS 1 // Not using any distribution lists as of 10/27/17
#if NUM_DIST_LISTS > 0 
#define DIST_LIST0 PostHypeLights
#endif
#if NUM_DIST_LISTS > 1 
...
#define EVENT_CHECK_LIST  Check4Keystroke, Check4GlassesEvent, CheckButtonEvents, CheckHandsUp //TODO: Fill this in!!!!
...
#define TIMER0_RESP_FUNC PostButton // Button
#define TIMER1_RESP_FUNC PostYeezy //RUN_TIMER
#define TIMER2_RESP_FUNC PostYeezy // CELEBRATION_TIMER
#define TIMER3_RESP_FUNC PostYeezy // RESET_TIMER
#define TIMER4_RESP_FUNC PostAudio // Hands up timer
#define TIMER5_RESP_FUNC PostNeedle
#define TIMER6_RESP_FUNC PostHypeLights // Celly Lights Timer
...
#define RUN_TIMER 1
#define CELEBRATION_TIMER 2
#define RESET_TIMER 3
#define HANDS_UP_TIMER 4                 
#define NEEDLE_TIMER 5
#define CELLY_TIMER 6
